...
#pragma warning restore SA1413 // Use trailing comma in multi-line initializers
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Mastery = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Maximum = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HitCollections", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Crystals = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TotalFights = table.Column<long>(nullable: false),
                    Wins = table.Column<long>(nullable: false),
                    Losses = table.Column<long>(nullable: false),
                    MaximalGoldSteal = table.Column<long>(nullable: false),
                    TotalGoldStolen = table.Column<long>(nullable: false),
                    TotalCrystalsStolen = table.Column<long>(nullable: false),
                    EarnedOnFarm = table.Column<long>(nullable: false),
                    EarnedOnPatrol = table.Column<long>(nullable: false),
                    EarnedInMines = table.Column<long>(nullable: false),
                    MonstersDefeated = table.Column<long>(nullable: false),
                    EarnedFromMonsters = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AttackerDamageDealt = table.Column<long>(nullable: false),
                    DefenderDamageDealt = table.Column<long>(nullable: false),
                    AttackerHealthLeft = table.Column<long>(nullable: false),
                    DefenderHealthLeft = table.Column<long>(nullable: false),
                    WinnerName = table.Column<string>(nullable: true),
                    LoserName = table.Column<string>(nullable: true),
                    HitCollectionId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Fights_HitCollections_HitCollectionId",
                        column: x => x.HitCollectionId,
                        principalTable: "HitCollections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Fights_HitCollectionId",
                table: "Fights",
                column: "HitCollectionId",
                unique: true);
